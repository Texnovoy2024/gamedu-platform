...
import { User, Star, TrendingUp, CheckCircle2, Coins, Flame, Save, KeyRound, Palette } from 'lucide-react'
import {
  getCurrentUserId, getUsers, upsertUser, calculateStudentStats,
  getCoinData, getStreak, getTitleForLevel,
} from '../../storage'
import type { User as UserType, StudentStats, CoinData, StreakData } from '../../types'
import { Modal } from '../../components/Modal'
import { XpBar } from '../../components/XpBar'
import { Rocket, Sword, Shield, Zap, Crown, Gem, Leaf, Target, Flame as FlameIcon, Globe, Cpu } from 'lucide-react'
    ...
    <div className="space-y-5">
      ...
      <form onSubmit={handleSubmit} className="rounded-2xl border border-slate-800 bg-slate-950/80 p-5 space-y-4">
        ...
        <div className="space-y-1.5">
          ...
          <input value={user.id} disabled className="w-full rounded-xl border border-slate-800 bg-slate-900/80 px-3 py-2 text-sm text-slate-500" />
        </div>
        <div className="space-y-1.5">
